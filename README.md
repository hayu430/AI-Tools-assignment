...
**Student:** Hayu Yonatan
**GitHub:** [https://github.com/hayu430/AI-Tools-Assignment](https://github.com/hayu430/AI-Tools-Assignment)  
...
**Choose TF for production (TFLite, Serving), PyTorch for research.**

#### Q2: Jupyter Use Cases
1. **EDA**: Visualize data, test preprocessing interactively  
2. **Prototyping & Teaching**: Build models cell-by-cell with explanations

#### Q3: spaCy vs String Ops
| Task | Strings | spaCy |
|------|--------|-------|
| NER | Manual regex | Pre-trained models |
| Speed | Slow | 10x faster |
| Accuracy | Low | High |

**spaCy = industrial NLP, strings = error-prone**
...
| Community | Mature | Huge (DL-focused) |
